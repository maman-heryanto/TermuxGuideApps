...
public class DbAdapterNote {
    ...
    public DbAdapterNote(Context context) {
        this.context = context;
    }

    public DbAdapterNote() {
    }

    public DbAdapterNote open() throws SQLException {
    ...
    //untuk insert data
    public boolean insertData(Note_app catatan) {
    ...
    //untuk update data
    public boolean updateData(Note_app catatan, int id) {
        ContentValues cv = new ContentValues();
        cv.put(TITLE_CATATAN, catatan.getTitle());
        cv.put(ISI_CATATAN, catatan.getIsi());
        cv.put(WARNA_CATATAN, catatan.getWarna());
